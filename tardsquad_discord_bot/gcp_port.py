...
def start_server(port):
    ...
    while True:
        ...
        conn.send("Thank you for connecting, but we're only listening here because Google Cloud Run requires us to do. Nothing to do...\n".encode())
        conn.close()
...
def start_gcp_port(port):
    ...
    This is really a dummy TCP listener needed because Google Cloud Run requires the service to listen to the from envionment specified $PORT.
